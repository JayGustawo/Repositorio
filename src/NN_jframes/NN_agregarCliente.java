 ...
 */
public class NN_agregarCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(B_agregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 205, 80, 40));
    ...
    public void confirm(){
        ...
        if(okLName && okFName && okPhone && valFN && valLN){
            ...
            boolean success = db.addClient(addClient);
            if(success){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_agregarCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NN_agregarCliente().setVisible(true);
            }
        });
    }
