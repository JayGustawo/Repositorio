 ...
 */
public class NN_ProductoVerificacion extends javax.swing.JFrame {

    DatabaseManager db;
    NN_JframeAdmin manager;
    NN_InventarioMain productoMenu;
    /**
     * Creates new form NN_ClienteVerificacion
     */
    public NN_ProductoVerificacion() {
        initComponents();
        setMinimumSize(new Dimension(490,160).getSize());
        db = NN_MainClass.db;
        NN_JframeAdmin manager = NN_MainClass.getManager();
        productoMenu = manager.managerInventoryMain;
    ...
    private void initComponents() {
        ...
        getContentPane().add(B_confirm, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 90, -1, -1));
        ...
        getContentPane().add(PF_pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 50, 274, -1));
    ...
    public void confirm(){
        ...
        if(db.checkAdmin(userPass)){
            boolean success = db.removeProductById(productoMenu.selectedId);
            if(success){
               productoMenu.refreshTable();
               productoMenu.display("Se elimino correctamente el producto");
               productoMenu.enable(true);
               this.dispose();
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_ProductoVerificacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NN_ProductoVerificacion().setVisible(true);
            }
        });
    }
