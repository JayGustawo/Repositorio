 ...
 */
public class NN_EmpleadoAdminVer extends javax.swing.JFrame {

    DatabaseManager db;
    NN_JframeAdmin manager;
    NN_editarEmpleado editarMenu;
    /**
     * Creates new form NN_ClienteVerificacion
     */
    public NN_EmpleadoAdminVer() {
        initComponents();
        setMinimumSize(new Dimension(450,165).getSize());
        db = NN_MainClass.db;
        NN_JframeAdmin manager = NN_MainClass.getManager();
        editarMenu = manager.managerEditarEmpleado;
    ...
    public void confirm(){
        ...
        if(db.checkAdmin(userPass)){
            boolean success = db.editEmployee(editarMenu.selectedEmployee);
            if(success){
               editarMenu.validated(true);
               editarMenu.setEnabled(true);
               this.dispose();
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_EmpleadoAdminVer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NN_EmpleadoAdminVer().setVisible(true);
            }
        });
    }
