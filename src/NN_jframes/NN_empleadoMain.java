 ...
 */
public class NN_empleadoMain extends javax.swing.JFrame {
     ...
     */
    public NN_empleadoMain() {
        initComponents();
        hidebttn();
        setMinimumSize(new Dimension(1000,715).getSize());
        manager = NN_MainClass.getManager();
        db = NN_MainClass.db;
        DefaultTableModel amodel = (DefaultTableModel)table_empleados.getModel();
        amodel.setRowCount(0);
        try{
            Class.forName("oracle.jdbc.driver.OracleDriver");
            Connection conn = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "proyectouser", "proyecto");
            String colhead[]={"ID","Primer nombre","Apellidos","Direccion","Usuario","Telefono","Rol"};
            amodel.setColumnIdentifiers(colhead);
            Statement stmt = conn.createStatement();
            ResultSet rs = stmt.executeQuery("Select ID,FIRSTNAME,LASTNAME,ADDRESS,USERNAME,PHONE,ROLE FROM EMPLOYEE ORDER BY ID ASC");
        ...
        table_empleados.setDefaultEditor(Object.class, null);
    }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(113, 214, 207), 3));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 64, 980, 520));
        ...
        T_clienteseleccionado.setText("id de empleado seleccionado");
        ...
        getContentPane().add(B_salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(877, 635, 90, 30));
        ...
        getContentPane().add(B_agregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 640, 83, 30));
        ...
        getContentPane().add(B_editar, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 640, 90, 30));
        ...
        getContentPane().add(B_eliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 640, 82, 30));
        ...
        getContentPane().add(TB_textSelect, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 590, 39, -1));
        ...
        buttonA.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/NinaNails/Empleadomain/Empleadomain_button.png"))); // NOI18N
        getContentPane().add(buttonA, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 630, 90, 50));

        buttonE.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/NinaNails/Empleadomain/Empleadomain_button.png"))); // NOI18N
        getContentPane().add(buttonE, new org.netbeans.lib.awtextra.AbsoluteConstraints(118, 640, 90, 30));

        buttonED.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/NinaNails/Empleadomain/Empleadomain_button.png"))); // NOI18N
        getContentPane().add(buttonED, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 630, -1, 50));

        buttonS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/NinaNails/Empleadomain/Empleadomain_button.png"))); // NOI18N
        getContentPane().add(buttonS, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 630, -1, 40));

        Line.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/NinaNails/Empleadomain/Empleadomain_line.png"))); // NOI18N
        getContentPane().add(Line, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 590, -1, 40));
        ...
        TAB.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/NinaNails/Empleadomain/Empleadomain_tab.png"))); // NOI18N
    ...
    @Override
    public void mouseClicked(java.awt.event.MouseEvent evt) {
        int row = table_empleados.rowAtPoint(evt.getPoint());
        int col = table_empleados.columnAtPoint(evt.getPoint());
        if (row >= 0 && col >= 0) {
            DefaultTableModel amodel = (DefaultTableModel)table_empleados.getModel();
    ...
    private void B_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B_eliminarActionPerformed
        ...
        try{
            ...
            ok = false;
            selectedId = 0;
            JOptionPane.showMessageDialog(null, "Id de empleado invalido", "ID invalido", JOptionPane.INFORMATION_MESSAGE);
        }
       if(ok){
            Employee query = db.getEmployeeById(selectedId);
            if(query.getId()==selectedId){
                manager.openEmpleadoVer();
                this.enable(false);
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_empleadoMain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NN_empleadoMain().setVisible(true);
            }
        });
    }
