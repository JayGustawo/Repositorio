...
public class NN_CitaVerificacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(PF_pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 60, 274, -1));
        ...
        getContentPane().add(B_confirm, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 100, -1, -1));
    ...
    public void confirm(){
        ...
        if(db.checkAdmin(userPass)){
            boolean success = db.removeAppointment(citaMenu.selectedId);
            if(success){
               citaMenu.refreshTable();
               citaMenu.display("Se elimino correctamente la cita");
               citaMenu.enable(true);
               this.dispose();
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_CitaVerificacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NN_CitaVerificacion().setVisible(true);
            }
        });
    }
