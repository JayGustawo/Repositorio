 ...
 */
public class NN_editarClienteAppointment extends javax.swing.JFrame {

    DatabaseManager db;
    boolean busy = false;
    NN_JframeAdmin manager;
    NN_clienteMainAppointment clienteAppMenu;
    int fromEdit;
    /**
     * Creates new form NN_agregarCliente
     */
    public NN_editarClienteAppointment() {
        initComponents();
        ...
        db = NN_MainClass.db;
        clienteAppMenu = manager.managerAgregarCitaCliente;
        Client editCliente = db.getClientebyId(clienteAppMenu.selectedId);
    ...
    private void initComponents() {
        ...
        getContentPane().add(B_agregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 210, 90, 30));
        ...
        T_Success.setText("-");
        getContentPane().add(T_Success, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 210, 330, -1));
        ...
        getContentPane().add(line8, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 200, 120, 50));
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        clienteAppMenu.refreshTable();
        clienteAppMenu.enable(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_editarClienteAppointment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NN_editarClienteAppointment().setVisible(true);
            }
        });
    }
