 ...
 */
public class NN_editarClientePago extends javax.swing.JFrame {
    
    DatabaseManager db;
    boolean busy = false;
    NN_JframeAdmin manager;
    NN_clienteMainPago clientePayMenu;
    int fromEdit;
    /**
     * Creates new form NN_agregarCliente
     */
    public NN_editarClientePago() {
        initComponents();
        ...
        db = NN_MainClass.db;
        clientePayMenu = manager.managerAgregarPagoCliente;
        Client editCliente = db.getClientebyId(clientePayMenu.selectedId);
    ...
    private void initComponents() {
        ...
        getContentPane().add(B_agregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(487, 205, 90, 40));
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        clientePayMenu.refreshTable();
        clientePayMenu.enable(true);
        this.dispose(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_editarClientePago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NN_editarClientePago().setVisible(true);
            }
        });
    }
