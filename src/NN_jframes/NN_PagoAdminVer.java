 ...
 */
public class NN_PagoAdminVer extends javax.swing.JFrame {

    DatabaseManager db;
    NN_JframeAdmin manager;
    NN_EditarPago editarMenu;
    /**
     * Creates new form NN_ClienteVerificacion
     */
    public NN_PagoAdminVer() {
        initComponents();
        db = NN_MainClass.db;
        NN_JframeAdmin manager = NN_MainClass.getManager();
        editarMenu = manager.managerPagoEdit;
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(480, 155));
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_PagoAdminVer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NN_PagoAdminVer().setVisible(true);
            }
        });
    }
