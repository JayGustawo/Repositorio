 ...
 */
public class NN_PagoVerificacion extends javax.swing.JFrame {

    DatabaseManager db;
    NN_JframeAdmin manager;
    NN_pagoMain pagoMenu;
    /**
     * Creates new form NN_ClienteVerificacion
     */
    public NN_PagoVerificacion() {
        initComponents();
        db = NN_MainClass.db;
        NN_JframeAdmin manager = NN_MainClass.getManager();
        pagoMenu = manager.managerPagoMain;
    ...
    private void initComponents() {
        ...
        getContentPane().add(B_confirm, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 110, -1, -1));
    ...
    public void confirm(){
        ...
        if(db.checkAdmin(userPass)){
            boolean success = db.removePaymentById(pagoMenu.selectedId);
            if(success){
               pagoMenu.refreshTable();
               pagoMenu.display("Se elimino correctamente el pago");
               pagoMenu.enable(true);
               this.dispose();
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_PagoVerificacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NN_PagoVerificacion().setVisible(true);
            }
        });
    }
