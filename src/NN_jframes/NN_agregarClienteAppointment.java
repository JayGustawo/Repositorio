 ...
 */
public class NN_agregarClienteAppointment extends javax.swing.JFrame {

    boolean busy = false;
    DatabaseManager db;
    NN_JframeAdmin manager;
    NN_agregarCita addCitaMenu;
    NN_EditarCita editCitaMenu;
    public boolean fromEdit;
    /**
     * Creates new form NN_agregarCliente
     */
    public NN_agregarClienteAppointment() {
        initComponents();
        ...
        if(fromEdit){
            editCitaMenu = manager.managerCitaEdit;
        }
        else{
            addCitaMenu = manager.managerAgregarCita;
        }
        //int newid = db.getMaxClient() + 1;
        int newid = db.getMax("CLIENT");
    ...
    private void initComponents() {
        ...
        getContentPane().add(B_agregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 230, -1, 30));
        ...
        T_Success.setText("-");
        getContentPane().add(T_Success, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 239, 460, 30));
        ...
        getContentPane().add(TB_firstName, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 70, 380, -1));
        ...
        getContentPane().add(TB_lastName, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 108, 380, -1));

        TB_phone.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        TB_phone.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        getContentPane().add(TB_phone, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 146, 380, -1));
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        if(fromEdit){
            editCitaMenu.enable(true);
            fromEdit = false;
            this.dispose();
        }
        else{
            addCitaMenu.enable(true);
            fromEdit = false;
            this.dispose();
        }
    ...
    public void confirm(){
        ...
        if(okLName && okFName && okPhone && valFN && valLN){
            ...
            if(fromEdit){
                manager.managerCitaEdit.idClienteSolicita = addClient;
                manager.managerCitaEdit.updateAppointmentNewClientData(addClient);
                manager.managerCitaEdit.setEnabled(true);
                fromEdit = false;
                this.dispose();
            }
            else{
                manager.managerAgregarCita.idClienteSolicita = addClient;
                manager.managerAgregarCita.updateAppointmentNewClientData(addClient);
                manager.managerAgregarCita.setEnabled(true);
                fromEdit = false;
                this.dispose();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_agregarClienteAppointment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NN_agregarClienteAppointment().setVisible(true);
            }
        });
    }
