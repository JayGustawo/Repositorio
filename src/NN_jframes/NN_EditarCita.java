 ...
 */
public class NN_EditarCita extends javax.swing.JFrame {
    ...
    public NN_EditarCita() {
        ...
        selAppointment = db.getAppointmentById(appointmentMenu.selectedId);
        Client queryClient = db.getClientebyId(selAppointment.getId_c());
        if(queryClient.getId()!=0   ){
            try{
                idClienteSolicita = db.getClientebyId(selAppointment.getId_c());
        ...
        CBO_dia.setSelectedIndex(selAppointment.getDay()-1);
        ogDay = selAppointment.getDay();
        ogMonth = selAppointment.getMonth();
        ogYear = selAppointment.getYear();
        ogHourValue = selAppointment.getHourValue();
        CBO_mes.setSelectedIndex(selAppointment.getMonth());
        setYearIndex(selAppointment.getYear());
        String yearString = selAppointment.getHour();
        yearString = yearString.substring(0, yearString.length()-3);
        StringTokenizer hourToken = new StringTokenizer(yearString,":");
        TB_hora.setText(hourToken.nextToken());
        TB_minutos.setText(hourToken.nextToken());
        if(selAppointment.getHourValue()>12.59){
            CB_turno.setSelectedIndex(1);
        }
        TA_razon.setText(selAppointment.getReason());
        int newid = selAppointment.getId();
    ...
    private void initComponents() {
        ...
        getContentPane().add(B_editar, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 475, 80, 40));
        ...
        T_Success.setText("-");
        getContentPane().add(T_Success, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 440, 540, 30));
        ...
        getContentPane().add(B__selectCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 475, -1, 40));
        ...
        getContentPane().add(B_nuevoCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 475, -1, 40));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 250, 290, 180));
        ...
        getContentPane().add(line8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 470, 130, 50));
    ...
    public void finishAppointment(){
        ...
        newAppointment.setId(appointmentMenu.selectedId);
    ...
    private void B__selectClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B__selectClienteActionPerformed
        ...
        manager.managerAgregarCitaCliente.fromEdit = true;
        this.enable(false);
    ...
    private void B_nuevoClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_B_nuevoClienteActionPerformed
        ...
        manager.managerAgregarCitaAgregarCliente.fromEdit = true;
        this.enable(false);
