 ...
 */
public class NN_EmpleadoVerificacion extends javax.swing.JFrame {

    DatabaseManager db;
    NN_JframeAdmin manager;
    NN_empleadoMain empleadoMenu;
    /**
     * Creates new form NN_ClienteVerificacion
     */
    public NN_EmpleadoVerificacion() {
        initComponents();
        setMinimumSize(new Dimension(450,165).getSize());
        db = NN_MainClass.db;
        NN_JframeAdmin manager = NN_MainClass.getManager();
        empleadoMenu = manager.managerEmpleadoMain;
    ...
    private void initComponents() {
        ...
        getContentPane().add(B_confirm, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 110, -1, -1));
        ...
        getContentPane().add(PF_pass, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, 274, -1));
    ...
    public void confirm(){
        ...
        if(db.checkAdmin(userPass)){
            boolean success = db.removeEmployee(empleadoMenu.selectedId);
            if(success){
               empleadoMenu.refreshTable();
               empleadoMenu.display("Se elimino correctamente al empleado");
               empleadoMenu.enable(true);
               this.dispose();
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_EmpleadoVerificacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NN_EmpleadoVerificacion().setVisible(true);
            }
        });
    }
