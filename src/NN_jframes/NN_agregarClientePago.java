 ...
 */
public class NN_agregarClientePago extends javax.swing.JFrame {

    DatabaseManager db;
    boolean busy = false;
    NN_JframeAdmin manager;
    NN_agregarPago addPayMenu;
    NN_EditarPago editPagoMenu;
    public boolean fromEdit;
    /**
     * Creates new form NN_agregarCliente
     */
    public NN_agregarClientePago() {
        initComponents();
        ...
        if(fromEdit){
            editPagoMenu = manager.managerPagoEdit;
        }
        else{
            addPayMenu = manager.managerAgregarPago;
        }
    ...
    private void initComponents() {
        ...
        T_Success.setText("-");
        getContentPane().add(T_Success, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 227, 450, 40));
        ...
        line8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/NinaNails/pagoMain/pagoMain_button.png"))); // NOI18N
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        ...
        if(fromEdit){
            editPagoMenu.enable(true);
            fromEdit = false;
            this.dispose();
        }
        else{
            addPayMenu.enable(true);
            fromEdit = false;
            this.dispose();
        }
    ...
    public void confirm(){
        ...
        if(okLName && okFName && okPhone && valFN && valLN){
            ...
            if(fromEdit){
                ...
                manager.managerAgregarPago.idClienteSolicita = addClient;
                manager.managerAgregarPago.updateAppointmentNewClientData(addClient);
                manager.managerAgregarPago.setEnabled(true);
                fromEdit = false;
                this.dispose();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NN_agregarClientePago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NN_agregarClientePago().setVisible(true);
            }
        });
    }
